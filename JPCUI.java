...
public class JPCUI extends UserInterface {
    ...
    public void getFactorRankings(final List<Factor> factors,
        ...
        for (int i = 0; i < factors.size(); i++) {
            while (true) {
                System.out.print("How important is '" + factors.get(i).getName() + "' on a scale of 0 to " + standard + " (default " + baseline + "): ");
    ...
    public double[][] getCrossRankings(final List<Alternative> alternatives,
        ...
        for (int i = 0; i < factors.size(); i++) {
            ...
            for (int j = 0; j < alternatives.size(); j++) {
                while (true) {
                    System.out.print("    Enter a value for '" + alternatives.get(j).getDescriptor() + "' on a scale 0 to " + standard + " (default 10): ");
